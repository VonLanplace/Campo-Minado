...
public class RedButton extends BasicButtonUI {
	Color topColor;
	Color bottomColor;
	Color pressedTopColor;
	Color pressedBottomColor;

	public RedButton() { // Define cores para o gradiente vermelho
		this.topColor = new Color(220, 60, 60); // Vermelho mais claro (topo)
		this.bottomColor = new Color(180, 30, 30); // Vermelho mais escuro (base)
		this.pressedTopColor = new Color(200, 40, 40); // Vermelho pressionado (topo)
		this.pressedBottomColor = new Color(160, 20, 20); // Vermelho pressionado (base)
	}
